...
export const routes: Routes = [
  ...
  { path: "forgotpassword", component: ForgotPasswordComponent, data: {breadcrumb:"Not Found"}},
  {
    ...
    children: [
      {path:"dashboard",component:DashboardComponent,loadChildren:'./me/dashboard/dashboard.module#DashboardModule',data:{breadcrumb:'Dashboard'}},
      { path: "", redirectTo: "dashboard", pathMatch: "full" },      
      { path: 'admin', loadChildren: './me/admin/admin.module#AdminModule', data: { breadcrumb: 'Carriers' } },
      { path: 'admin/organisation', loadChildren: './me/admin/organisations/organisations.module#OrganisationsModule', data: { breadcrumb: 'Carriers' } },
      { path: 'admin/master-data', loadChildren: './me/admin/master-data/master-data.module#MasterDataModule', data: { breadcrumb: 'Master Data' } },
