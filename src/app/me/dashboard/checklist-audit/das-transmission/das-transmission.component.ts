...
@Component({
  selector: 'app-das-transmission',
  templateUrl: './das-transmission.component.html',
  styleUrls: ['./das-transmission.component.scss']
})
export class DasTransmissionComponent implements OnInit {
