...
@Component({
  selector: 'app-model-trend-pa',
  templateUrl: './model-trend-pa.component.html',
  styleUrls: ['./model-trend-pa.component.scss']
})
export class ModelTrendPaComponent implements OnInit {
