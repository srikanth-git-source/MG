...
@Component({
  selector: 'app-das-par-model',
  templateUrl: './das-par-model.component.html',
  styleUrls: ['./das-par-model.component.scss']
})
export class DasParModelComponent implements OnInit {
