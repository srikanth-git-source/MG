...
@Component({
  selector: 'app-model-trend-ca',
  templateUrl: './model-trend-ca.component.html',
  styleUrls: ['./model-trend-ca.component.scss']
})
export class ModelTrendCaComponent implements OnInit {
