...
export const routes = [
  ...
  {path:'repeated-issues',component:RepeatedIssuesComponent,loadChildren: './repeated-issues/dashboard-repeated-issues.module#DashboardRepeatedIssuesModule',data:{breadcrumb:'Dashboard'}},
];
