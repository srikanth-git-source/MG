...
@Component({
  selector: 'app-par-overview',
  templateUrl: './par-overview.component.html',
  styleUrls: ['./par-overview.component.scss']
})
export class ParOverviewComponent implements OnInit {
